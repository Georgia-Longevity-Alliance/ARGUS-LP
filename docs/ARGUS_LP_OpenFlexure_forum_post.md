**Title:** ARGUS-LP_OS — autonomous 24/7 cell lineage tracker on OpenFlexure v6.1.5
...
ARGUS-LP_OS is a robotic microscope that watches mammalian cells divide for weeks at a time, tracks who came from whom, and zaps selected cells with a 405 nm laser. It lives in a sealed box at 37°C with HEPA-filtered air, and the whole thing runs unattended.
