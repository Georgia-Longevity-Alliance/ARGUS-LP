...
> **Минимальный набор маркеров:** Centrin1-GFP + SiR-Tubulin + Arl13B. **Возраст = количество делений. Траектория = последовательность XY-векторов** (Z measured but lower precision — ~1 µm vs ~0.25 µm for XY). Судьба = Arl13B⁺.
