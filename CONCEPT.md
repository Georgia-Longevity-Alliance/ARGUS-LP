...
> **Минимальный набор маркеров:** Centrin1-GFP (позиция центриолей) + SiR-Tubulin (вектор веретена) + Arl13B (цилия, endpoint). **Возраст = количество пройденных делений** (не длина траектории в пикселях). Судьба = Arl13B⁺ или дифференцировочный маркер.
