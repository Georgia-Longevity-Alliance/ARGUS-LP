...
If you discover a security vulnerability in ARGUS-LP_OS (especially laser safety for v2.0, network-exposed control systems, or night vision IR exposure), please report it privately:
...
ARGUS-LP_OS v1.0 does NOT use lasers. The only light sources are:
...
ARGUS-LP_OS v2.0 adds a femtosecond laser (NIR 800 nm, Class 3B). Hardware safety measures include:
